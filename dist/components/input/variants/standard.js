...
export var Standard = forwardRef(function (_a, ref) {
    var variant = _a.variant, _b = _a.type, type = _b === void 0 ? "text" : _b, onChange = _a.onChange, onBlur = _a.onBlur, onFocus = _a.onFocus, placeholder = _a.placeholder, name = _a.name, props = __rest(_a, ["variant", "type", "onChange", "onBlur", "onFocus", "placeholder", "name"]);
    var inputProps = {
        onChange: onChange,
        onBlur: onBlur,
        onFocus: onFocus,
