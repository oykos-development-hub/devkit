...
export var Secondary = forwardRef(function (_a, ref) {
    var onClick = _a.onClick, _b = _a.iconPosition, iconPosition = _b === void 0 ? "left" : _b, props = __rest(_a, ["onClick", "iconPosition"]);
    return (React.createElement(StyledSecondaryButton, __assign({ type: "button" }, props, { onClick: function () { return (onClick ? onClick() : null); }, iconPosition: iconPosition || "left", ref: ref }),
