...
export var Primary = styled.button(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  ", ";\n  background-color: ", ";\n  border-color: ", ";\n  color: ", ";\n\n  &:hover:not([disabled]) {\n    background-color: transparent !important;\n    color: ", ";\n  }\n"], ["\n  ", ";\n  background-color: ", ";\n  border-color: ", ";\n  color: ", ";\n\n  &:hover:not([disabled]) {\n    background-color: transparent !important;\n    color: ", ";\n  }\n"])), shared, function (props) { return backgroundColor(props); }, function (props) { return borderColor(props); }, function (props) { return color(props); }, function (props) { return backgroundColor(props); });
