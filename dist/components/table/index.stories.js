...
var tableHeadings = ["City", "Code", "Latitude", "Longitude"];
var tableData = [
...
var Default = function (args) { return (React.createElement(StoryWrapper, null,
    React.createElement(Table, __assign({}, args)))); };
export var DefaultTable = Default.bind({});
DefaultTable.args = {
    ...
    headerContent: (React.createElement("tr", null, tableHeadings.map(function (heading, index) { return (React.createElement("th", { key: index },
        React.createElement("div", null,
            React.createElement("span", null, heading),
            React.createElement(CircleCheckIcon, { size: "1em", onClick: function () { return alert("Icon is clicked"); }, style: { cursor: "pointer" } })))); }))),
    bodyContent: tableData.map(function (data, index) { return (React.createElement("tr", { key: index },
...
export var NoDataTable = Default.bind({});
NoDataTable.args = {
    headerContent: (React.createElement("tr", null, tableHeadings.map(function (heading, index) { return (React.createElement("th", { key: index },
        React.createElement("div", null,
            React.createElement("span", null, heading),
