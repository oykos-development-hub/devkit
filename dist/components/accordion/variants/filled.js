...
export var Filled = function (_a) {
    ...
    return (React.createElement(StyledMainWrapper, __assign({ variant: "filled", collapsed: isCollapsed || collapsed, scrollHeight: height }, props),
