...
export var Avatar = function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? AvatarVariants.circle : _b, src = _a.src, _c = _a.size, size = _c === void 0 ? AvatarSizes.md : _c, style = _a.style, name = _a.name, source = _a.source, theme = _a.theme;
    return (React.createElement(Container, { style: style, theme: theme },
        ...
        variant === AvatarVariants.square && (React.createElement(Row, null,
