...
export declare const Pagination: ({ data, itemsPerPage, previousLabel, nextLabel, renderContent, renderPaginationText, theme, variant, style, displayPages, pageRangeDisplayed, fullWidth, }: import("./types").PaginationProps) => JSX.Element;
