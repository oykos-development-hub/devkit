...
export declare const Button: (props: import("./types").ButtonProps) => JSX.Element;
...
export declare const RangeDatePicker: (props: import("./types").RangeDatePickerProps) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
