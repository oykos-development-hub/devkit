...
const AssignIcon = (props: IconProps): React.ReactElement => {
    ...
    return (
        <Svg data-testid="assign-icon" viewBox="0 0 16 16" {...props}>
            <Path d="M14 2H10V0H16V6H14V2Z" {...props} />
            <Path d="M10 14H14V10H16V16H10V14Z" {...props} />
            <Path d="M6 2H2V6H0V0H6V2Z" {...props} />
            <Path d="M6 14H2V10H0V16H6V14Z" {...props} />
            <Path
