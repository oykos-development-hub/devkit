import { ModalBox, ModalContainer, ModalHeader } from "@oykos-development/devkit-react-ts-styled-components";
import styled, { DefaultTheme } from "styled-components";

const Container = styled.div<{ theme: DefaultTheme; open: boolean }>`
  position: relative;
  z-index: 10;
  ${ModalBox} {
    /* min-height: 350px; */
